...
function loading(){
	document.getElementById('calendar-container').innerHTML = "<div id=\"calendar-body\"><div style=\"padding: 10px 5px 5px 5px;\"><div align=\"center\" style=\"background-color: #ffffff; height: 50px; padding: 25px; 3px 5px 3px;\">Refreshing Calendar...</div></div></div>";
}
...
//window.onload = function(){ setValue(); closeMe(); };
//-->
</script>
</head>
...
<div id="calendar-header" align="center">
	...
	<form id="calendarform" name="calendarform" method="post" action="<?php echo($thispage);?>" style="margin: 0px;">
	  <table border="0" cellspacing="0" cellpadding="1">
		<tr>
		  <td><select class="input_txt" name="m" onchange="javascript:submitCalendar();">
		  <?php
		  ...
		  <td><select class="input_txt" name="y" onchange="javascript:submitCalendar();">
		  <?php
		  $thisyear = date('Y');
