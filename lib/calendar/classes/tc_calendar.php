...
class tc_calendar{
	...
	function writeScript(){
		...
		echo("<div id=\"div_".$this->objname."\" style=\"position: relative;display:".$div_display.";z-index:10000;\"><IFRAME id=\"".$this->objname."_frame\" style=\"DISPLAY:block; LEFT:0px; POSITION:".$iframe_position."; TOP:0px;\" src=\"".$this->path."calendar_form.php".$paramStr."\" frameBorder=\"0\" scrolling=\"no\" height=\"$this->height\" width=\"$this->width\" allowtransparency=\"true\"></IFRAME></div>");		
	}
	
	//write the select box of days
	function writeDay(){
		echo("<select class=\"input_txt\" name=\"".$this->objname."_day\" id=\"".$this->objname."_day\" onChange=\"javascript:tc_setDay('".$this->objname."', this[this.selectedIndex].value, '$this->path');\" class=\"tcday\">");
	...
	function writeMonth(){
		echo("<select class=\"input_txt\" name=\"".$this->objname."_month\" id=\"".$this->objname."_month\" onChange=\"javascript:tc_setMonth('".$this->objname."', this[this.selectedIndex].value, '$this->path');\" class=\"tcmonth\">");
	...
	function writeYear(){
		...
		echo("<select  class=\"input_txt\" name=\"".$this->objname."_year\" id=\"".$this->objname."_year\" onChange=\"javascript:tc_setYear('".$this->objname."', this[this.selectedIndex].value, '$this->path');\" class=\"tcyear\">");
