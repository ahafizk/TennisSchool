...
<div id="art-main">
       ...
       <br/>
       				<div class="content_body" align="left">
                    <form name="ane1" action="sendInvoice.php" method="post">
                    <input type="hidden" name="email" value="<?php echo $user['email'][0];?>" />
                    <input type="hidden" name="user_id" value="<?php echo $user['id'][0]; ?>"/>
                    <input type="hidden" name="initial" value="<?php echo $user['initial'][0]; ?>"/>
                    <input type="hidden" name="call_name" value="<?php echo $user['call_name'][0]; ?>"/>
                    <input type="hidden" name="last_name" value="<?php echo $user['last_name'][0]; ?>"/>
                    <input type="hidden" name="middle_name" value="<?php echo $user['middle_name'][0]; ?>"/>
                    <table cellpadding="2" cellspacing="5">
<!--                    <tr><td class="input_level">Do you Want to send Invoice? If yes! Please click the Paynent button.</td></tr>
                    
                    <tr>
                    <td><input class="art-button" type="submit" name="invoice" value="Invoice" /></form><a href="../admin/paymentMenu.php"><input class="art-button" type="button" name="Cancel" value="Cancel"/></a></td>-->
                    </tr>
