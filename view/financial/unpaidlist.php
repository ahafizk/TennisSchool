...
//require_once('../../control/student/csearchlist.php');
session_start();
if($_SESSION['auths']!=1)
{
...
<div id="art-main">
        ...
        <a href="#" class=" active"><span class="l"></span><span class="r"></span></a> </div>
			...
			<div id="navbalk">
                ...
                <div id="navpos3">
                <img src="../../images/spacer.gif" style="height: 5px; width: 14px;" alt="">
                <a href="list.php"><img src="../../images/icon64_leerlingen_nw.png" style="height: 32px;" alt=""><br> 
                &gt; Unpaid List</a>
                &nbsp;&nbsp;</div>
                ...
                <img src="../../images/uitloggen.png" alt="Uitloggen" onclick="window.open('../../common/logout.php', '_self')"><br><div class="lockleerlingWrap">Logged in: <?Php  echo $_SESSION['USER']; ?></div>
                     ...
                     <div id="navtitel">
                       <div align="left">List Of Unpaid students</div>
                    </div>
                  ...
                  <script src="../../js/financial/unpaid.js"></script>
