<?php
require_once('../../control/financial/csummary.php');
session_start();
if($_SESSION['auths']!=1)
{
        ...
        <a href="#" class=" active"><span class="l"></span><span class="r"></span></a> </div>
			...
			<div id="navbalk">
               ...
               <img src="../../images/uitloggen.png" alt="Uitloggen" onclick="window.open('../../common/logout.php', '_self')"><br><div class="lockleerlingWrap">Logged in: <?Php  echo $_SESSION['USER']; ?></div>
                     ...
                     <div id="navtitel">
                       <div align="left">Financial Summary</div>
                    </div>
        		
                 <br/>
                  <form name="form1" action="changeuser1.php" method="post">
                  
                   <div align="left">
                  <div id="title_1" align="center" style="width: 130px" >Summary</div>
                  </div>
                  <div class="content_body" align="left">
                  <table cellpadding="5" cellspacing="2">
                  <tr>
                  <td class="input_level">Total Students(Paid):</td>
                  <td class="input_txt"><?php echo $total_paid_student; ?></td>
                  </tr>
                  <tr>
                  <td class="input_level">Total Students(Unpaid):</td>
                  <td class="input_txt"><?php echo $total_unpaid_student; ?></td>
                  </tr>
                  <tr>
                  <td class="input_level">Total Amounts Paid:</td>
                  <td class="input_txt"><?Php echo $total_amount; ?></td>
                  </tr>
                  <tr>
                  <td class="input_level">Total Dues(total+vat):</td>
                  <td class="input_txt"><?php echo $total_dues['total'].'+'.$total_dues['vat']." = ".($total_dues['total']+$total_dues['vat']);?></td>
                  </tr>
                  </table>
                  </div>
                  </form>
