<?php
require_once('../../control/settings/cshowannounce1.php');
session_start();
if($_SESSION['auths']!=1)
{
			...
			<div id="navbalk">
              ...
              &nbsp;&nbsp;</div>
                ...
                <img src="../../images/uitloggen.png" alt="Uitloggen" onclick="window.open('../../common/logout.php', '_self')"><br><div class="lockleerlingWrap">Logged in: <?Php  echo $_SESSION['USER']; ?></div>
                  ...
                  <tr>
                  <td class="input_level">Subject:</td>
                  <td class="input_txt"><?php echo $record['subject'][0]?></td>
                  </tr>
                  <tr>
                  <td class="input_level">Date:</td>
                  <td class="input_txt"><?php echo $record['date'][0];?></td>
                  </tr>
                  <tr>
                  <td class="input_level">Body:</td>
                  <td class="input_txt"><?php echo $record['body'][0];?></td>
                  </tr>
                  
                  <tr>
                  <td class="input_level">Signature:</td>
                  <td class="input_txt"><?php echo $record['signature'][0];?></td>
                  </tr>
