...
<div id="art-main">
			...
			<div id="navbalk">
              ...
              &nbsp;&nbsp;</div>
                ...
                <img src="../../images/uitloggen.png" alt="Uitloggen" onclick="window.open('../../common/logout.php', '_self')"><br><div class="lockleerlingWrap">Logged in: <?Php  echo $_SESSION['USER']; ?></div>
                     ...
                     <div id="navtitel">
                       <div align="left">Set Announcement</div>
                    </div>
        		
                  
                  <br/>
                  <form name="form1" action="../../control/settings/cannounce.php" method="post">
                  
                   <div align="left">
                  <div id="title_1" align="center" style="width: 130px" >Announcement</div>
                  </div>
            	...
            	<td><div class="input_level">Subject:</div></td>
           	 	<td><input type="text" class="input_txt" size="30" name="subject" value="" /></td>
	  ...
	  ?></td></tr>
                ...
                <td><textarea class="input_txt" name="body" cols="100" rows="20"></textarea></td>
                </tr>
                 <tr>
                 <td class="input_level">Signature:</td>
                 <td><input type="text" name="signature" class="input_txt" size="30" value="" /></td>
                 </tr>
                 <tr>
                 <td class="input_level">Send All:</td>
                 <td class="input_level"><input type="checkbox" name="send" value="1" checked="checked" />(This will send announcement to all student)</td>
