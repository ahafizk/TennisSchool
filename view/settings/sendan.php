			...
			<div id="navbalk">
              ...
              &nbsp;&nbsp;</div>
               ...
               <img src="../../images/uitloggen.png" alt="Uitloggen" onclick="window.open('../../common/logout.php', '_self')"><br><div class="lockleerlingWrap">Logged in: <?Php  echo $_SESSION['USER']; ?></div>
                  ...
                  <br/>
                  <form name="form1" action="<?php echo "sendan1.php"; ?>" method="post">
				...
				?>
 				 ...
 				 <div align="left">
                  <div id="title_1" align="center" style="width: 160px" >Send type</div>
                  </div>
                  <div class="content_body" align="left">
                 
                  <table  cellpadding="5" cellspacing="2">
                  <tr>
                  <td class="input_level"><input type="radio" value="1" name="type" checked="checked" /></td>
            	<td><div class="input_level">Single</div></td>
           	 	
                
                </tr>
                  <tr>
                  <td class="input_level"><input type="radio" value="2" name="type" /></td>
            	<td><div class="input_level">All</div></td>
