<?php
//require_once('../../control/schedule/cschedule2.php');
require_once('../../control/schedule/clesson1.php');
?>
...
<div id="art-main">
  ...
  <tr>
    <td colspan="2" align="center">Lesson Type</td>
    </tr>
  <tr>
    <td>Type*</td>
    <td><label>
      <input type="text" name="lesson_type" id="textfield" value="<?php echo $_SESSION['lesson_type'];?>" />
    </label></td>
  </tr>
  <tr>
    <td>Name*</td>
    <td><label>
      <input type="text" name="lesson_name" id="textfield2" value="<?php echo $_SESSION['lesson_name']; ?>" />
    </label></td>
  </tr>
  <tr>
    <td>Description</td>
    <td><label>
      <textarea name="description" id="textarea" cols="45" rows="5"><?php echo $_SESSION['description']; ?></textarea>
    </label></td>
  </tr>
  <tr>
    <td>Start Date*</td>
    <td>Day: 
      ...
      <?php
      	for($i=1;$i<32;$i++)
		{
			if($_SESSION['day']==$i)$sel = "selected";
			else $sel ="";
    ...
    <?php 
	   for($i=1;$i<13;$i++)
	   {
		 if($_SESSION['month']==$i)$sel = "selected";
		 else $sel = "";
		 echo "<option value=\"".$i."\" ".$sel." >".$i."</option>";
	 	}
	?>
      ...
      <select name="year" id="select3">
	   ...
	   {
		 if($_SESSION['year']==$i)$sel = "selected";
		 else $sel = "";
		 echo "<option value=\"".$i."\" ".$sel." >".$i."</option>";
	 	}
        ?>
  ...
  <tr>
    ...
    <td>Day:
      <label>
        <select name="day1" id="select4">
        <?php
      	for($i=1;$i<32;$i++)
		{
			if($_SESSION['day1']==$i)$sel = "selected";
			else $sel ="";
			echo "<option value=\"".$i."\" ".$sel." >".$i."</option>";
		}
	  ?>
        ...
        <label>
        Month:
  <select name="month1" id="select5">
  <?php 
	   for($i=1;$i<13;$i++)
	   {
		 if($_SESSION['month1']==$i)$sel = "selected";
		 else $sel = "";
		 echo "<option value=\"".$i."\" ".$sel." >".$i."</option>";
	 	}
	?>
  ...
  <label>
        Year:
  <select name="year1" id="select6">
  <?php
	   
       for($i=date('Y');$i<(date('Y')+10);$i++)
	   {
		 if($_SESSION['year1']==$i)$sel = "selected";
		 else $sel = "";
		 echo "<option value=\"".$i."\" ".$sel." >".$i."</option>";
	 	}
        ?>
  ...
  <tr>
    <td>Age Group</td>
    <td><label>
      <input type="text" name="age_group" id="textfield3" value="<?php echo $_SESSION['age_group']; ?>" />
    </label></td>
  </tr>
   <tr>
   ...
   <tr>
    <td>Total Lesson*</td>
    <td><label>
      <input type="text" name="total_lesson" id="textfield4" value="<?php echo $_SESSION['total_lesson']; ?>" />
    </label></td>
  </tr>
   <tr>
    <td>Frequency</td>
    <td><label>
      <select name="frequency" id="select7">
      <option value="1">1 times per week</option>
      </select>
    </label></td>
  </tr>
   <tr>
    <td>Intented Skill</td>
    <td><select name="intented_skill" id="select8">
    <option value="1">All skills</option>
    </select></td>
  </tr>
   <tr>
    <td>Duration per Lesson*</td>
    <td><label>
      <input type="text" name="duration" id="textfield5" value="<?php echo $_SESSION['duration']; ?>" />
    </label></td>
  </tr>
   <tr>
    <td>Comment</td>
    <td><label>
      <textarea name="comment" id="textarea2" cols="45" rows="5"><?php echo $_SESSION['comment']; ?></textarea>
    </label></td>
  </tr>
  <tr>
  <td>&nbsp;</td><td align="right" valign="middle"><label>
    <input type="submit" name="lesson_button" id="lesson_button" value="Next" />
  </label></td>
  </tr>
</table>
                       <p>&nbsp;</p>
