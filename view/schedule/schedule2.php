            ...
            <div class="art-Sheet-body">
                ...
                <div class="art-contentLayout">
                    ...
                    <div class="art-content">
						...
						for($i=0;$i<$cntLoc;$i++)
						{
                        	echo "<option>".$loc['location'][$i]."</option>";
						}
						?>
                        </select>
                        ...
                        <br/>
						<form name="form22" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
						...
						{
                        	echo "<tr>";
							$time = $report->get_distinct_time($i,$location);
							$tm = 'time_'.$i;
							$_SESSION[$tm] = $time;
							...
							for($j=0;$j<$cntTm;$j++)
							{
								...
								$data = $report->get_location_wise_report($location,$time['start_time'][$j],$i );
								$dt = 'data_'.$j;
								$_SESSION[$dt] = $data;
