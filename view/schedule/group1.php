<?php
require_once('../../control/schedule/cgroup1.php');
?>
                ...
                <div class="art-contentLayout">
                    ...
                    <div class="art-content">
                        ...
                        <div class="art-Post">
                            ...
                            <div class="art-Post-body">
                        <div class="art-Post-inner art-article">
                        <form name="form_34" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        Lesson Type:
                        ...
                        <input type="submit" name="get_les" value="Get" />
                        </form>
                        <br/>
                        <br/>
                        <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                          <table border="1" cellspacing="2" cellpadding="2">
                            ...
                            <tr>
                              <td>Lesson Type</td>
                              <td><?Php echo $ls['lesson_type'][0]; ?></td>
                            </tr>
                            <tr>
                              <td>Lesson Name</td>
                              <td><?php echo $ls['name'][0]; ?></td>
                            </tr>
                            <tr>
                              <td>Age Group</td>
                              <td><?php echo $ls['age_group'][0]; ?></td>
                            </tr>
                            <tr>
                              <td colspan="2">&nbsp;</td>
                            </tr>
                            <tr>
                              <td>Max member:</td>
                              <td><label>
                                <input type="text" name="max_member" id="textfield" value="<?php echo $_SESSION['max_member'];?>" />
                              </label></td>
                            </tr>
                            <tr>
                              <td>Total Trainer:</td>
                              <td><label>
                                <input type="text" name="total_trainer" id="textfield2" value="<?php echo $_SESSION['total_trainer'];?>" />
                              </label></td>
                            </tr>
                            <tr>
                              <td>Number job:</td>
                              <td><input type="text" name="job_num" id="textfield3" value="<?php echo $_SESSION['job_num'];?>" /></td>
                            </tr>
                            <tr>
                              <td>Explanation:</td>
                              <td><label>
                                <textarea name="explanation" id="textarea" cols="45" rows="5"><?php echo $_SESSION['explanation'];?></textarea>
                              </label></td>
                            </tr>
                            <tr>
                              <td colspan="2">&nbsp;</td>
