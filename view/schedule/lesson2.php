...
require_once('../../control/schedule/clesson2.php');
?>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                          <table border="1" cellspacing="2" cellpadding="2">
                            ...
                            for($i=0;$i<$total_w;$i++)
							{
								...
								$com = 'comment'.$i;
								echo "<tr>";
                              	echo "<td><input type=\"text\" name =\"$yname\" value = \"".$yer."\"/></td>";
                              	echo "<td><input type=\"text\" name =\"$wname\"  value = \"".$ws."\" ></td>";
                              	echo "<td><textarea name=\"$com\" id=\"textarea\" ></textarea></td>";
                            	echo "</tr>";
								if($ws==52){$ws=0;$yer = $_SESSION['year1'];}
								$ws++;
							}
							?>
                            <tr>
                            ...
                            <tr>
                              <td colspan="3"><label>
                                <input type="submit" name="lesson_save" id="lesson_save" value="save" />
                              </label></td>
                            </tr>
                          </table>
