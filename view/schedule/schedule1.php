<?php
require_once('../../control/schedule/cschedule1.php');
?>
                ...
                <div class="art-contentLayout">
                    ...
                    <div class="art-content">
                        ...
                        <div class="art-Post">
                            ...
                            <div class="art-Post-body">
                        <div class="art-Post-inner art-article">
                        <form name="form12" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                        <select name="week_day">
                        <option value="1">Mon Day</option>
                        <option value="2">Thues Day</option>
                        <option value="3">Wednes Day</option>
                        <option value="4">ThusDay</option>
                        <option value="5">Fri Day</option>
                        <option value="6">Sat Day</option>
                        <option value="7">Sun day</option>
                        </select>
                        ...
                        <br/>
						<form name="form22" action="move_schedule.php" method="post">
                        <table bgcolor="#00CCFF" border="0" cellspacing="30" cellpadding="4">
                        <tr>
                        <td>Location</td>
                        <td>Time</td>
                        <td>Persons</td>
                        ...
                        <td>Lesson Name</td>
                        <td>Max Member</td>
                        <td>Available Member</td>
                        </tr>
                        <?php
						for($i=0;$i<$cntLoc;$i++)
						{
                        	echo "<tr>";
							$time = $report->get_distinct_time($week_day,$loc['location'][$i]);
							$tm = 'time'.$i;
							$_SESSION[$tm] = $time;
							$cntTm = count($time['start_time']);
							
                        	echo "<td rowspan=\"$cntTm\">".$loc['location'][$i]."</td>";
							
							for($j=0;$j<$cntTm;$j++)
							{
                        		echo "<td>".$time['start_time'][$j]."--".$time['end_time'][$j]."</td>";
                        	
								$data = $report->get_day_wise_report($week_day,$loc['location'][$i],$time['start_time'][$j] );
								$dt = 'data'.$j;
								$_SESSION[$dt] = $data;
								$cntD = count($data['call_name']);
								//echo "<td><table>";
								//echo "<tr><td>".$data['call_name'][$i]."  ".$data['last_name'][$i]."</td></tr>";
								echo "<td>";
								for($k=0;$k<$cntD;$k++)
								{
									$val = $data['lookup_id'][$k].",".$data['user_id'][$k];
									$name = 'checkbox'."".$i."".$j."".$k;
									echo "<label>";
  									echo "<input type=\"checkbox\" name=\"$name\" id=\"checkbox\" value=\"$val\" />";
									
									echo $data['call_name'][$k]."  ".$data['last_name'][$k];
									echo "</label>";
									//if(($k+1)<$cntD)echo "<hr>";
									echo "<br/><br/>";
								}
								echo "</td>";
								//echo "</table></td>";
                        		echo "<td>".$data['lesson_type'][0]."</td>";
                        		echo "<td>".$data['lesson_name'][0]."</td>";
                        		echo "<td>".$data['max_member'][0]."</td>";
                        		echo"<td>".$data['available_member'][0]."</td>";
                        		echo "</tr>";
							}
						}
                        ?>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="submit" name="show" value="Show Detail"/>
