...
require_once('../../control/schedule/cmake_schedule.php');
session_start();
if($_SESSION['auths']!=1)
{
			...
			<div id="navbalk">
              ...
              &nbsp;&nbsp;</div>
                ...
                <img src="../../images/uitloggen.png" alt="Uitloggen" onclick="window.open('../../common/logout.php', '_self')"><br><div class="lockleerlingWrap">Logged in: <?Php  echo $_SESSION['USER']; ?></div>
                  ...
                  <div align="left">
                  <div id="title_1" align="center" style="width: 160px" >Make schedule</div>
                  </div>
                  <br/>
                   <div class="content_body" align="left">
                   
                   <br/>
                   <label class="input_level">Students are schedule according to their choice Successfully. </label>
