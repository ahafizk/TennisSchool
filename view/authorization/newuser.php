...
<div id="art-main">
        ...
        <a href="#" class=" active"><span class="l"></span><span class="r"></span></a> </div>
			...
			<div id="navbalk"></div>
                     ...
                     <div id="navtitel">
                       <div align="left">New User </div>
                    </div>
        		
                  
                  <br/>
                  <form name="form1" action="../../control/authorization/cnewuser.php" method="post">
            	...
            	<td><div class="input_level">User Name*</div></td>
           	 	<td><input id="user_name1" size="30" class="validate[required,custom[names],length[0,50]] text-input input_txt " type="text" name="user_name"value="<?php echo $_SESSION['user_name']; ?>" onkeyup="showHint(this.value)"/></td>
	  ...
	  ?></td>
       ...
       <div class="content_body" align="left">
        ...
        <a href="../teachers/index.php"><input class="art-button" type="button" name="Cancel" value="Cancel"/></a>
        </div>
        <div class="content_body" align="left">
