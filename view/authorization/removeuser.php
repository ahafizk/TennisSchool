<?php
require_once('../../control/authorization/cremoveuser.php');
session_start();
if($_SESSION['auths']!=1)
{
			...
			<div id="navbalk">
              ...
              &nbsp;&nbsp;</div>
                ...
                <img src="../../images/uitloggen.png" alt="Uitloggen" onclick="window.open('../../common/logout.php', '_self')"><br><div class="lockleerlingWrap">Logged in: <?Php  echo $_SESSION['USER']; ?></div>
                     ...
                     <div id="navtitel">
                       <div align="left">Remove User </div>
                    </div>
                  ...
                  <form name="form1" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                   ...
                   <div align="left">
                  <div id="title_1" align="center" style="width: 130px" >User change</div>
                  </div>
                  <div class="content_body" align="left">
                  <p class="input_level">Please select a user to remove from the database and click remove. Note: it will permanently delete from the database.</p>
                  <table  cellpadding="5" cellspacing="2">
                  <tr>
            	<td><div class="input_level">Select User Name</div></td>
           	 	<td><select id="user" class="input_txt" name="user_id">
                
				<?php
				for($i=0;$i<$cnt;$i++)
				{
					$str = "<option value=\"".$record['id'][$i]."\">".$record['user_name'][$i]."</option>";
					echo $str;
				}
				?>
                </select>
