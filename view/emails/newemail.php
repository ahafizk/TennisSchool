...
<div id="art-main">
			...
			<div id="navbalk">
              ...
              &nbsp;&nbsp;</div>
                ...
                <img src="../../images/uitloggen.png" alt="Uitloggen" onclick="window.open('../../common/logout.php', '_self')"><br><div class="lockleerlingWrap">Logged in: <?Php  echo $_SESSION['USER']; ?></div>
                     ...
                     <div id="navtitel">
                       <div align="left">Send Email</div>
                    </div>
        		
                  
                  <br/>
                  <form name="form1" action="processemail.php" method="post">
                  
                   <div align="left">
                  <div id="title_1" align="center" style="width: 150px" >Send Email</div>
                  </div>
            	...
            	<td><div class=\"input_level\">To:</div></td>
           	 	<td><input type=\"text\" class=\"input_txt\" size=\"30\" name=\"email\" value=\"".$_SESSION['to']."\" /></td>
            	...
            	<td><div class="input_level">Subject:</div></td>
           	 	<td><input type="text" class="input_txt" size="30" name="subject" value="<?php echo $_SESSION['subject']; ?>" /></td>
	  ...
	  ?></td></tr>
                <tr>
                <td class="input_level">Body:</td>
                <td><textarea class="input_txt" name="body" cols="100" rows="20"><?php echo $_SESSION['body']; ?></textarea></td>
                </tr>
                 <tr>
                 <td class="input_level">Signature:</td>
                 <td><input type="text" name="signature" class="input_txt" size="30" value="<?php echo $_SESSION['signature']; ?>" /></td>
                 </tr>
        ...
        <a href="../admin/index.php"><input class="art-button" type="button" name="Cancel" value="Cancel"/></a>
        </div>
        <div class="content_body" align="left">
