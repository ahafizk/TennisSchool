...
require_once('../../control/level/cgroupDetails1.php');
require_once('../../common/common.php');
session_start();
if($_SESSION['auths']!=1)
{
			...
			<div id="navbalk">
              ...
              &nbsp;&nbsp;</div>
                ...
                <img src="../../images/uitloggen.png" alt="Uitloggen" onclick="window.open('../../common/logout.php', '_self')"><br><div class="lockleerlingWrap">Logged in: <?Php  echo $_SESSION['USER']; ?></div>
                     ...
                     <div id="navtitel">
                       <div align="left">Group Details Information</div>
                    </div>
                  ...
                  <div align="left">
                  <div id="title_1" align="center" style="width: 160px" >Group Details Information</div>
                  </div>
                  <br/>
                  <form name="fd" action="groupDetails2.php" method="post">
        		<div class="content_body" align="left">
                
   				<table cellpadding="5" cellspacing="2">
                <tr><td class="input_level">Select Lesson:</td><td >
                <select class="input_txt" name="group_id">
                <?php
				for($i=0;$i<$cnt;$i++)
				{
                	echo "<option value=\"".$lesson['group_id'][$i].",".$lesson['lesson_id'][$i]."\">".$lesson['lesson_type'][$i]." / ".$lesson['lesson_name'][$i]."</option>";
				}
				?>
                </select>
                </td></tr>
				  ...
				  <div class="content_body" align="left">
        <input class="art-button" type="submit" name="save" value="Search"/>
