...
require_once('../../control/level/cviewLesson.php');
require_once('../../common/common.php');
session_start();
if($_SESSION['auths']!=1)
{
        ...
        <a href="#" class=" active"><span class="l"></span><span class="r"></span></a> </div>
			...
			<div id="navbalk">
              ...
              &nbsp;&nbsp;</div>
                <div id="navpos3">
                <img src="../../images/spacer.gif" style="height: 5px; width: 14px;" alt="">
                <a href="#"><img src="../../images/level/icon64_niveau_volg.png" style="height: 32px;" alt="">
                <br> 
                &gt;View Lessons </a>&nbsp;</div>
                ...
                <img src="../../images/uitloggen.png" alt="Uitloggen" onclick="window.open('../../common/logout.php', '_self')"><br><div class="lockleerlingWrap">Logged in: <?Php  echo $_SESSION['USER']; ?></div>
                     ...
                     <div id="navtitel">
                       <div align="left">Lesson Information</div>
                    </div>
                ...
                <td class=\"input_txt\">".$group_info['name'][$i]."</td>
                <td class=\"input_txt\">".$group_info['start_date'][$i]."</td>
                <td class=\"input_txt\">".$group_info['end_date'][$i]."</td>
                <td class=\"input_txt\">".$group_info['num_lesson'][$i]."</td>
                <td class=\"input_txt\">".$group_info['duration_per_lesson'][$i]."</td>
