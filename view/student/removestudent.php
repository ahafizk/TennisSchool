...
<div id="art-main">
        ...
        <a href="#" class=" active"><span class="l"></span><span class="r"></span></a> </div>
			...
			<div id="navbalk">
               ...
               <img src="../../images/uitloggen.png" alt="Uitloggen" onclick="window.open('../../common/logout.php', '_self')"><br><div class="lockleerlingWrap">Logged in: <?Php  echo $_SESSION['USER']; ?></div>
                     ...
                     <div id="navtitel">
                       <div align="left">Remove Student </div>
                    </div>
        		
                  
                  <br/>
                  <form name="edit" action="../../control/student/cremovestudent.php" method="post">
            	...
            	<td><div class="input_level">Initial*</div></td>
           	 	<td><input id="initial" class=" input_txt " type="text" name="initial"value="<?php echo $user['initial'][0]; ?>"/>
                <input type="hidden" id="user_id" name="user_id" value="<?php echo $user['id'][0]; ?>"/></td>
            	<td><div class="input_level">Call Name*</div></td>
            	<td><input id="call_name" class=" input_txt " type="text" name="call_name"  value="<?php echo $user['call_name'][0]; ?>"/></td>
          		</tr>
          		<tr>
            	<td><div class="input_level">Middle Name</div></td>
           	 	<td><input class="input_txt" type="text" name="middle_name"value="<?php echo $user['middle_name'][0]; ?>"/></td>
            	<td><div class="input_level">Last Name*</div></td>
            	<td><input id="last_name" class="input_txt " type="text" name="last_name"  value="<?php echo $user['last_name'][0]; ?>"/></td>
          		</tr>
          		<tr>
	  ...
	  ?></td>
                ...
                <td><textarea id="last_name" class="input_txt " type="textarea"  name="comment"><?php echo $user['other_detail'][0]; ?></textarea>  </td>
                </tr>
        		</tbody>
        		</table>
        </div>
         ...
         <table cellpadding="5" cellspacing="2">
           <tr>
            <td><div class="input_level">Street*</div></td>
           	<td><input id="street" class=" input_txt " type="text" name="street" value="<?php echo $user['street'][0]; ?>"/></td>
            <td><div class="input_level">House Number*</div></td>
           	<td><input id="house_number" class="input_txt " type="text" name="house_number" value="<?php echo $user['house_number'][0]; ?>"/></td>
           </tr>
           <tr>
             <td><div class="input_level">Post Code*</div></td>
           	<td><input id="post_code" class=" input_txt " type="text" name="post_code" value="<?php echo $user['post_code'][0]; ?>"/></td>
            <td><div class="input_level">Location*</div></td>
           	<td><input id="location" class=" input_txt " type="text" name="home_palate" value="<?php echo $user['home_plate'][0]; ?>"/></td>
           </tr>
           <tr>
             <td><div class="input_level">Phone Number</div></td>
           	<td><input class="input_txt" type="text" name="telephone" value="<?php echo $user['telefoon_vast'][0]; ?>"/></td>
            <td><div class="input_level">Mobile Number</div></td>
           	<td><input class="input_txt" type="text" name="mobile" value="<?php echo $user['telefoon_mobiel'][0]; ?>"/></td>
           </tr>
           <tr>
             <td><div class="input_level">Email Address</div></td>
           	<td><input id="email" class=" input_txt " type="text" name="email" value="<?php echo $user['email'][0]; ?>"/></td>
            <td><div class="input_level">Fax</div></td>
           	<td><input class="input_txt" type="text" name="fax" value="<?php echo $user['fax'][0]; ?>"/></td>
           </tr>
         </table>
       </div>
       ...
       <div id="title_1" align="center" style="width: 82px" >Tennis Info</div>
          ...
          <table cellpadding="5" cellspacing="2" >
            <tr>
              <td><div class="input_level">Member of association</div></td>
           	<td><input class="input_txt" type="text" name="knl_id" value="<?php echo $user['id_association'][0]; ?>"/></td>
            <td><div class="input_level">Tennis Bond number</div></td>
           	<td><input class="input_txt" type="text" name="bond_number" value="<?php echo $user['tb_bonds_nummer'][0]; ?>"/></td>
            </tr>
            <tr>
        ...
        <br/>
        <div class="content_body" align="left">
        <input class="art-button" type="submit" name="Remove" value="Remove"/>
