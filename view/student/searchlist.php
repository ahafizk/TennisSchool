...
$action = array('l'=>'list.php','c'=>'editstudent.php','r'=>'removestudent.php','m'=>'movestudent.php','w'=>'waitinglist.php');
$title = array('l'=>'Search for List of Assigned Student','w'=>'Search for Waiting List','c'=>'Search Student to Update Info','r'=>'Search Student to Remove From a Group','m'=>'Search Student to Move From One Group to Another.');
        ...
        <a href="#" class=" active"><span class="l"></span><span class="r"></span></a> </div>
			...
			<div id="navbalk">
                ...
                <img src="../../images/uitloggen.png" alt="Uitloggen" onclick="window.open('../../common/logout.php', '_self')"><br><div class="lockleerlingWrap">Logged in: <?Php  echo $_SESSION['USER']; ?></div>
                  ...
                  <br/>
                  <form name="form1" action="<?php echo $action_name; ?>" method="post">
                  ...
                  <div class="content_body" align="left">
                    ...
                    <table cellspacing="2" cellpadding="5">
                      <tr>
                        <td><div class="input_level"><input type="radio" name="radio" value=""/>All</div></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td><div class="input_level"><input  type="radio" name="radio" value="" />Lesson</div></td>
                        <td>
                        
                        <select class="input_txt" name="lesson">
                        <option>First Lesson</option>
                        <option>Second Lesson</option>
                        </select></td>
                      </tr>
                      <tr>
                        <td><div class="input_level"><input  type="radio" name="radio" value="" />Day</div></td>
                        <td>
