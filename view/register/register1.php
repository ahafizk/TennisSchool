            ...
            <div class="art-Sheet-body">
                ...
                <div class="art-contentLayout">
                    ...
                    <div class="art-content">
                        ...
                        <label><strong>Gebruikers info</strong></label><br/><br/>
                        <label>	Titel:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <label>Voornaam:</label>
                          ...
                          <option>Mannelijk</option>
                          <option>Vrouwelijk</option>
                          <option>Ander</option>
                          </select>
                          <br/>
                      	  <br/>
                          <label> Gebruikersnaam:</label>
                          <input type="text" name="user_name1"/><?php if($_POST['rs']==1)echo"your user name already exist!";?>
                          ...
                          <input type="password" name="password_re1"/>
                          <br/>
                          <br/>
                          ...
                          <br/>
                          <label><strong>
                          uw beschikbare tijd om de les:</strong></label>
                          ...
                          <label>Home gehemelte:</label>&nbsp;&nbsp;&nbsp;&nbsp;
                          <input type="text" name="home_palate"/>&nbsp;&nbsp;
                          <br/>
                          <br/>
                          ...
                          <br/>
                          <br/>
                          <label><strong>KNL TB</strong></label>
                          <br/>
                          <br/>
                          <label>id:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input type="text" name="knl_id"/>&nbsp;&nbsp;
                          <label>Obligaties nummer:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input type="text" name="bond_number"/>&nbsp;&nbsp;
                          <br/>
                          <br/>
                          <label>Skill-Single:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <select name="skill_single">
                          ...
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <label>Skill-Double:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <select name="skill_double">
                           <option selected="selected" value="0">select-one</option>
                          <?php
						  	for($i=0;$i<=10;$i++)
						  	echo "<option>$i</option>";
                          ...
                          <br/>
                          <br/>
                          <label><strong>Sporting Experience</strong></label>
                          <br/>
                          <br/>
                          <label>Level (Skill):</label>
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <select name="level_skill">
                          <option selected="selected" value="0">select-one</option>
                          <?php
						  	for($i=0;$i<=10;$i++)
						  	echo "<option>$i</option>";
                          ...
                          Diploma of Certificate?
                          <label>:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <select name="diploma_certificate" >
                          <option selected="selected" value="0">select-one</option>
                          <?php
						  	for($i=0;$i<=10;$i++)
						  	echo "<option>$i</option>";
                          ...
                          <br/>
                          <br/>
                          <label>enkele jaren had tennis:</label>
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <select name="had_tennis">
                          <option selected="selected" value="0">select-one</option>
                          <?php
						  	for($i=0;$i<=10;$i++)
						  	echo "<option>$i</option>";
                          ...
                          <label>Aantal jaren Gespeeld:</label>
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <select name="year_played">
                          ...
                          <label>Aantal jaren training:</label>
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <select name="year_workout">
                          <option selected="selected" value="0">select-one</option>
                          <?php
						  	for($i=0;$i<=10;$i++)
						  	echo "<option>$i</option>";
                         ...
                         <textarea style="position: absolute" name="explanation" ></textarea>                          
							<br/>
                            <br/>
  						 	<br/>
                            <br/>
