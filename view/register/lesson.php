<?php
require_once('../../control/cgroups.php');
require_once('../../control/clesson.php');
require_once('../../control/cassigngroup.php');
?>
                ...
                <div class="art-contentLayout">
                    ...
                    <div class="art-content">
                        ...
                        <div class="art-Post">
                            ...
                            <div class="art-Post-body">
                        <div class="art-Post-inner art-article">
                        <form name="lesson" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                          <p>
                              <label><strong>Les</strong></label>
                            <br/><br/>
...
&nbsp;                         
                         ...
                         <div style="position: absolute"> <label >beschrijving:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          
                     
                            <textarea style="position: inherit" name="description" ></textarea></div>
                          ...
                          <input type="text" size="10" name="num_lesson"/>&nbsp;&nbsp;
                          <br/>
                          <br/>
                          <label> aantal Tiems vrij spelen:</label>
                        &nbsp;
                          <input type="text" size="10"name="num_free_play"/>
                          <br/>
                      	  <br/>
                          <label> duur per sessie(min):</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input size="10" type="text" name="duration"/>
                          
                          
                          <br/>
                          <br/>
                          <div align="center">
                          <input  type="submit" name="lesson" value="voegen les"/>
                          </div>
                          </form>
                          <hr />
                          <br/>
                          <br/>
                          <form name="group_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                          <label><strong>nieuwe groep</strong></label>
                          <br/>
                          <br/>
                          ...
                          <option value="0" selected="selected">selecteren</option>
                          <?php 
						  for($i=0;$i<$countLess;$i++)
						  {
							  
                          	echo "<option value=\"".$lesson_name_id[$i]['id']."\">".$lesson_name_id[$i]['name']." </option>";
						  }
						  ?>
						  </select>
                          <br/>
                          <br/>
                          <label>totaal lid:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input type="text" name="total_member"/>
                          <br/>
                          <br/>
                          <label>beschikbare lid:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input type="text" name="available_member"/>
                          <br/>
                          <br/>
                          ...
                          <br/>
                          <br/>
                          <div align="center"><input type="submit" name="new_group" value="Groep maken" />
                          <hr />
                          </form>
                          <form name="assign_group" action="set_schedule.php" method="post">
						  ...
						  ?>
                          <div >kent een groep met een les aan het lid klik hieronder.</div>
                          <br/>
                          <label> <strong>toewijzen groep</strong></label>
                          <input type="submit" name="assign_group" value="toewijzen groep"/>
                          </form>
<div class="cleared"></div>
                        </div>
